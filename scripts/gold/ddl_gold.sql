...
Script Purpose:
     ...
     Each view performs transforamtions and combines data from the Silver layer
     to produce a clean, enriched, and businiess-ready dataset.
...
SELECT
	ROW_NUMBER() OVER (ORDER BY cst_id) AS customer_key, --Srrogate key
